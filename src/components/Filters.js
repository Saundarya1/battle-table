...
function Filters({ initialData, setTableData }) {
  ...
  return (
    <Navbar className="justify-content-between">
     <Navbar.Brand className='d-none d-md-block'>Filters:</Navbar.Brand>
      <Form inline>
        <div className="d-flex flex-column flex-md-row">
          ...
          <div className="col-12 col-md-2">
            <Dropdown>
              <Dropdown.Toggle className="col-12 col-md-10 mt-2 mt-md-0" variant="success" id="role-dropdown">
                Role
              </Dropdown.Toggle>
              <Dropdown.Menu>
          ...
          <div className="col-12 col-md-2">
            <Dropdown>
              <Dropdown.Toggle className="col-12 col-md-10 mt-2 mt-md-0" variant="success" id="rule-dropdown">
                Rules
              </Dropdown.Toggle>
              <Dropdown.Menu>
          ...
          <div className="col-12 col-md-2">
            <Dropdown autoClose="outside">
              <Dropdown.Toggle className="col-12 col-md-10 mt-2 mt-md-0" variant="success" id="tons-dropdown">
                Tons
              </Dropdown.Toggle>
              <Dropdown.Menu>
                <Dropdown.Item>
          ...
          <div className="col-12 col-md-2">
            <Dropdown autoClose="outside">
              <Dropdown.Toggle className="col-12 col-md-10 mt-2 mt-md-0" variant="success" id="bv-dropdown">
                BV
              </Dropdown.Toggle>
              <Dropdown.Menu>
                <Dropdown.Item>
